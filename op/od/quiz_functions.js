...
document.write('<input type="button" style="width:150px; height:150px; background-color:"'+bgcolor+'" " name="answer_' + ri + '" value="' + choices[ri][j] + '" id="answer_' + ri + '_' + j + '" class="question_' + ri + '" onclick="submitAnswer(' + ri + ', this, \'question_' + ri + '\', \'label_' + ri + '_' + j + '\')" /><label id="label_' + ri + '_' + j + '" for="answer_' + ri + '_' + j + '"> </label>');
} 
