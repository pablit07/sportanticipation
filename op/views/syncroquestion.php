...
$sql = "INSERT INTO st_question_summaries (`ts_test_id`,`ts_total_answered`,`ts_total_correct`,`ts_user_id`,`ts_started`,`ts_team`,`ts_title`,`ts_session_id`,`test_question_id`,`st_question_answered`,`test_question_answer_correct` )VALUES ('$test_id', '$test_question_count', '$correct', '$pid', '$sdate', '$test_team', '$test_title', '$testsessionid','$test_question_id','$test_question_answered ', '$test_question_answer_correct')";
