...
include_once('models/header.php');
    ...
    $tblDemo = new ajaxCRUD("Item", "st_tests", "test_id", "../");
...
?>
    ...
    <h2>test_question_count must match the number of questions in the question manager for a given batting side.</h2>
</div>